$(function () {
  ...
  for (var i = 0; i < target_adjuctment.length; i++) {
    height_adjuctment(
      target_adjuctment[i][0],
      target_adjuctment[i][1],
      target_adjuctment[i][2]
    );
  }
  $(window).resize(function () {
    for (var i = 0; i < target_adjuctment.length; i++) {
  ...
  if ($("#php_page_navi a:first").hasClass("prev")) {
    $(".wp-pagenavi_link_prev").attr(
      "href",
      $("#php_page_navi a:first").attr("href")
    );
  } else {
  ...
  if ($("#php_page_navi a:last").hasClass("next")) {
    $(".wp-pagenavi_link_next").attr(
      "href",
      $("#php_page_navi a:last").attr("href")
    );
  } else {
  ...
  if ($("#prev_single_navigation a").length == 1) {
    $(".single-nav-next a").attr(
      "href",
      $("#prev_single_navigation a").attr("href")
    );
  } else {
    $(".single-nav-next").css("visibility", "hidden");
  }
  if ($("#next_single_navigation a").length == 1) {
    $(".single-nav-previous a").attr(
      "href",
      $("#next_single_navigation a").attr("href")
    );
  } else {
